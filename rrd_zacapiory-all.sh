...
echo "Updating RRD $ds_name with values: $urbinek, $MichalR, $lksilesian, $MateuszL, $Bartek, $xmesaj2, $nataliad2412, $blazejpoland, $Blazejej, $Kamps, $NATKA"
$rrdtool update $db N:$urbinek:$MichalR:$lksilesian:$MateuszL:$Bartek:$xmesaj2:$nataliad2412:$blazejpoland:$Blazejej:$Kamps:$NATKA
